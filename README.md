...
[![License: MIT](https://img.shields.io/github/license/777marvin/ext-broke)](LICENSE)
[![Release](https://img.shields.io/github/v/tag/777marvin/ext-broke?sort=semver)](CHANGELOG.md)
...
- across all requests of the session, roughly **55 million tokens** in
  total were not re-sent;
